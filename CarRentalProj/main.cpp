...
int main() {
    ...
    rentalService.addCar(Car(1, "Toyota", "Camry", 50.0, {"GPS", "Air Conditioning"}, {10.0, 20.0}));
    rentalService.addCar(Car(2, "Honda", "Civic", 45.0, {"Bluetooth", "Heated Seats"}, {15.0, 25.0}));
    rentalService.addCar(Car(3, "Ford", "Focus", 40.0, {"Backup Camera"}, {12.0, 18.0}));
    rentalService.addCar(Car(4, "Tesla", "Model 3", 100.0, {"Autopilot", "Electric"}, {20.0, 30.0}));
